(function () {
    'use strict';
    angular.module("hpe").controller('geoManagementCtrl', GeoManagementCtrlFn)
    function GeoManagementCtrlFn($scope, $http, $state, $timeout, $rootScope, $localStorage, Notification) {
        ...
        var columnDefs = [
         { field: 'GeoName', width: '20%', enableHiding: false},
         { field: 'IsCountryLevel', width: '20%', displayName: 'Geo to Country Allocation', type: 'boolean', cellTemplate: Template, enableHiding: false },
        ...
        $http.get($rootScope.api + 'GeoSettings/GetGeoLevelData').success(function (response) {
            $scope.Data = response;
